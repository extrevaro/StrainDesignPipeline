...
def import_excel_model(file_excel_path, model_id="default_model"):
    ...
    #Import metabolites
    model_excel_metabolites=pd.read_excel(file_excel_path,sheet_name=MET_SHEET_ID, engine='openpyxl').dropna(how='all')
    ...
    #Import reactions
    model_excel_reactions=pd.read_excel(file_excel_path,sheet_name=RXN_SHEET_ID, engine='openpyxl').dropna(how='all')
